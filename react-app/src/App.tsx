...
import InProgressProjectPage from './pages/InProgressProjectPage';
...
const App = () => {
  return (
    <Routes>
      ...
      <Route path="/projects/pulsegate" element={<InProgressProjectPage project="pulsegate" />} />
      ...
      <Route path="/projects/novapay" element={<InProgressProjectPage project="novapay" />} />
